...
public class AsignacionCargaMenuActivity extends ListActivity {

    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[]
            activities={"AsignacionCargaInsertarActivity","AsignacionCargaEliminarActivity","AsignacionCargaConsultarActivity",
            "AsignacionCargaActualizarActivity"};
