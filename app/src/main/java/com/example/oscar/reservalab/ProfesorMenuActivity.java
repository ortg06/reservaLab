...
public class ProfesorMenuActivity extends ListActivity {

    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[]
            activities={"ProfesorInsertarActivity","ProfesorEliminarActivity","ProfesorConsultarActivity",
            "ProfesorActualizarActivity"};
